# Maquette Projet 6 - Site communautaire SnowTricks

Ceci est une maquette pour le projet 6 du parcours Développeur d'application - PHP / Symfony d'OpenClassrooms.
J'ai utilisé comme base le thème Modern Business de StartBoostrap.
